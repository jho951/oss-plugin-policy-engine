[SECURITY.md](../policy-config/SECURITY.md)# Security Policy
...
> E-mail: jho951@naver.com
>
> GitHub 메시지

### 다음 정보를 함께 제공해주신다면 감사하겠습니다.
- 어떤 부분에서 문제가 발생했는지
- 재현 가능한 예제 (가능한 경우)
- 영향받는 버전 또는 환경
...
2. 이슈가 확인되면 우선 수정 후, 필요 시 패치를 릴리스하겠습니다.
3. 심각한 문제일 경우 GitHub 릴리스 노트와 README에 공지하겠습니다.
